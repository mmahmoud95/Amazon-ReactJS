  ...
  return (
    <>
      ...
      >
        ...
        <div
          className=" d-flex justify-content-center p-0 m-0 w-100"
        >
          ...
          <div className="d-none d-lg-flex justify-content-around mb-3 container" >
            <div className="mx-5 mt-3 ">
              <Link className="text-decoration-none text-white">
                <span className="d-block">Amazon Advertising</span>
                <span className="text-secondary d-block">
                  Find, attract, and
                </span>
                <span className="text-secondary">engage customers</span>
              </Link>
            </div>
            <div className="mx-5 mt-3 ">
              <Link   className="text-decoration-none text-white">
                <span className="d-block">Sell on Amazon.ae</span>
            ...
            <div className="mx-5 mt-3 ">
              <Link   className="text-decoration-none text-white">
                ...
                <span className="text-secondary">Scalable Cloud</span>
            ...
            <div className="mx-5  mt-3">
              <Link   className="text-decoration-none text-white">
                ...
                <span className="text-secondary d-block">Book reviews</span>
                <span className="text-secondary"> & recommendations</span>
              </Link>
            </div>
          </div>
          ...
          <div className="d-none d-lg-flex justify-content-around mt-2  container" >
            <div className="">
              <Link   className="text-decoration-none">
                ...
                <span className="text-secondary d-block">Download</span>
                <span className="text-secondary"> Audio Books</span>
              </Link>
            </div>
            <div className="">
              <Link   className="text-decoration-none ">
                <span className="d-block text-white"> IMDb</span>
                <span className="text-secondary d-block">Movies, TV</span>
                <span className="text-secondary"> & Celebrities</span>
              </Link>
            </div>
            <div className="">
              <Link   className="text-decoration-none text-white">
            ...
            <div className="">
              <Link   className="text-decoration-none text-white">
                ...
                <span className="text-secondary d-block">Designer</span>
                <span className="text-secondary">Fashion Brands</span>
              </Link>
            </div>
