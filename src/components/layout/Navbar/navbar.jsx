  ...
  return (
    <>
            ...
            <ul className="navbar-nav align-items-lg-center">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu p-2">
                  <li>
                    <input type="radio" id="arabic" name="languge" />
                    <label htmlFor="arabic">العربية- AR</label>
                  </li>
                  <hr />
                  <li>
                    <input type="radio" id="english" name="languge" />
                ...
                <ul className="dropdown-menu">
                  <li>
                    ...
                    <p className="register">
                      New customer?
                      <a href="../register-page/register.html">Start here.</a>
                    </p>
                    <hr />
                  </li>
                  <li>
                    ...
                    <p className="fw-bold mb-0">Your Account</p>
                    <a
              ...
              <li className="nav-item">
                <a className="nav-link order" href="../orders/order.html">
                  Orders
                </a>
              </li>
              <li className="">
                ...
                >
                  ...
                  <span className="cart text-decoration-none">Cart</span>
                </NavLink>
              </li>
            </ul>
          </div>
      ...
      <div className="search-bar-meduim d-flex d-lg-none">
        ...
        <div className="h-100">
          <ion-icon className="serch-icon" name="search-outline"></ion-icon>
        </div>
      </div>
      <div className="menu">
