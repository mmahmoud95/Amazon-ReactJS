        ...
        <div className="row">
            <div className="col-md-8 bg-white p-5 pt-3 shadow">
                <div className="head-cart mb-0">
                    <h3>Shopping Cart</h3>
                    <a href="#" className="deselect text-decoration-none">Deselect all items</a>
                </div>
                <hr />
                ...
                <div className="row" key={index}>
                    <div className="item col-md-3 col-sm-12 d-flex align-items-center">
                        <div className="mt-3 mb-3">
                            <img className="w-100" width="500px" src={product.thumbnail} />
                        </div>
                    </div>
                            ...
                            <ul className="list-unstyled d-flex flex-row list">
                                ...
                                <li>
                                    <a href="#" className="text-decoration-none me-2"
                                        onClick={()=>handelRemove(product)} >Delete</a>
                                </li>
                                <li>
                                    <a href="#" className="text-decoration-none me-2">Save for later</a>
                                </li>
                                <li>
                                    <a href="#" className="text-decoration-none me-2">Share</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div className="col-md-3 p-0 mx-md-4 my-2 my-md-0">
                    <div className="shadow p-3 bg-white mb-2">
                        <p className="total-cart">
                            <ion-icon name="checkmark-circle"></ion-icon> Your
                            order qualifies for FREE Shipping Choose this option
                            at checkout. <a href="#">See details</a>
                        </p>
                        <p className="total-price">
                            Subtotal ({cartPage.length}items) :
                            <span className="price">{cartPage.length} </span>
                        </p>
                        <a href="#" className="to-buy d-inline-block text-decoration-none" >Proced to buy</a   >
                    </div>
