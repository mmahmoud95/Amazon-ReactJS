              ...
              {isLogin ? (
                <span>
                  <div className="head-cart mb-0">
                    <h3>{t("cart.part2")}</h3>
                    <a href="#" className="deselect text-decoration-none">
                      {t("cart.part3")}
                    </a>
                  </div>
                  <hr />
                  ...
                  cartProducts?.map((item, index) => (
                    <div className="row" key={index}>
                      ...
                      <div className="col-md-7 col-sm-12 justify-content-center flex-column mt-3 mb-3">
                        ...
                        <p className="price h5">EGP: {item.price}</p>
                        ...
                        <p className="stock">
                          stock:
                          {item.productId.quantityInStock}
                        </p>
                        <div className="mt-3">
                ...
                cartPage?.length > 0 ? (
                  <div className="shadow p-3 bg-white mb-2">
                    <p className="total-cart">
                      ...
                      {t("cart.part11")} <a href="#">{t("cart.part12")}</a>
                    </p>
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate("/checkout", {
                          state: { product: cartPage, totalPrice:totalPrice,cartID:cartId},
                        })
                      }
                      disabled={!isLogin}
                    >
                  ...
                  <div className="row" key={index}>
                    ...
                    <div className="col-md-7 col-sm-12 justify-content-center flex-column mt-3 mb-3">
                      <h5>
                        ...
                        >
                          {lang === "en"
                            ? item.product?.en.description
                            : item.product?.ar.description}
                        </Link>
                      </h5>
                      <p className="price h5">EGP: {item.product?.price}</p>
                        ...
                        <ul className="list-unstyled d-flex flex-row list">
                          <li className="h-100">
                            <div>
                              <button
                                className="btn btn-dark"
                                aria-label="Increment value"
                                onClick={() => handelincreasRedux(index)}
                              >
                                +
                              </button>
                              <span>
                                {" "}
                                {t("cart.part5")}
                                {cartPageRedux[index].quantity}{" "}
                              </span>
                              <button
                                className="btn btn-dark"
                                aria-label="Decrement value"
                                onClick={() => handeldecresRedux(index)}
                              >
                                -
                              </button>
                            </div>
                          ...
                          <li>
                            <a
                              href="#"
                              className="text-decoration-none me-2"
                              onClick={() => handelRemoveRedux(item.product)}
                            >
                              {t("cart.part4")}
                            </a>
                          </li>
              ...
              {cartPageRedux?.length > 0 ? (
                <div className="shadow p-3 bg-white mb-2">
                  ...
                  <p className="total-price">
                    ...
                    ) :<span className="price">{total}5555</span>
                  </p>
                  {/* // ))} */}
                  <button
                    className="to-buy d-inline-block text-decoration-none text-info"
