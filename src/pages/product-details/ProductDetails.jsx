      ...
      <div className="container-fluid">
        <div className="row m-0 py-2 border-bottom ">
          ...
          <div className="col-lg-5 p-2">
            ...
            >
              {myProd?.images.map((image, index) => (
                <div key={index} className="" style={{ height: "" }}>
                  <img src={image} alt={"product images"} className="h-100" />
                </div>
              ))}
            </Carousel>
          </div>
          ...
          <div  className="col-lg-4  ">
            <h2 className="product-title fw-normal">{myProd?.description}</h2>
            ...
            <div className="product-detail border-bottom">
              <ul className="list-group list-group-horizontal ">
                ...
                <li className="list-group-item border-0">{myProd?.brand}</li>
              </ul>
              ...
              <ul className=" list-unstyled list-group list-group-horizontal ">
                ...
                <li className="list-group-item border-0">{myProd?.title}</li>
              </ul>
              ...
              <ul className="list-group list-group-horizontal">
                ...
                <li className="list-group-item border-0">{myProd?.category}</li>
              </ul>
              ...
              <ul className="list-group list-group-horizontal">
                ...
                <li className="list-group-item border-0">{myProd?.stock}</li>
              </ul>
            ...
            <div className="p-2  pb-4">
              ...
              <div className="progress mb-2">
                <div
                  ...
                  role="progressbar"
                  style={{ width: "60%", backgroundColor: "#FFA41C" }}
                  aria-valuenow="100"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
              ...
              <div className="progress mb-2">
                <div
                  className="progress-bar  "
                  role="progressbar"
                  style={{ width: "20%", backgroundColor: "#FFA41C" }}
                  aria-valuenow="80"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
              ...
              <div className="progress mb-2">
                <div
                  className="progress-bar  "
                  role="progressbar"
                  style={{ width: "7%", backgroundColor: "#FFA41C" }}
                  aria-valuenow="60"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
              ...
              <div className="progress mb-2">
                <div
                  className="progress-bar  "
                  role="progressbar"
                  style={{ width: "8%", backgroundColor: "#FFA41C" }}
                  aria-valuenow="40"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
              ...
              <div className="progress ">
                <div
                  className="progress-bar  "
                  role="progressbar"
                  style={{ width: "5%", backgroundColor: "#FFA41C" }}
                  aria-valuenow="20"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
            ...
            <div className="m-2 p-2">
              <div className="d-block">
                <h6 className="text-start text-dark">
                 <p> <i className="fa-solid fa-user fa-lg "></i>Hamza Mohamed</p>
                </h6>
                ...
                <div className="small d-flex justify-content-start">
                  <a href="#" className="d-flex align-items-center me-3" target="_blank">
